...
public class Constant {
    ...
    public static final String RedisSysConfigsKey="SpringBoot:Center:SysConfigs:all";

    public static final String DefaultSysCode="system_center";

    public static final String DefaultPostName="暂无岗位！";
